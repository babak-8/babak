...
document.querySelectorAll('.navbar-link').forEach(link => {
  link.addEventListener('click', function () {
    // Tüm navbar-link'lerden active class'ını kaldır
    document.querySelectorAll('.navbar-link').forEach(l => l.classList.remove('active'));
    // Sadece tıklanan link'e active ekle
    this.classList.add('active');

    // Tüm sayfalardan active class'ını kaldır
    document.querySelectorAll('[data-page]').forEach(page => page.classList.remove('active'));

    // Tıklanan linkin metnine göre ilgili sayfayı bul ve active ekle
